...
public class WhenComesTheBusTest {
    @Rule
    public PactProviderRuleMk2 provider = new PactProviderRuleMk2("BusService", "localhost", 8111, this);
...
/*    @Test
    ...
    public void doFailTest() {
        System.setProperty("pact.rootDir","target/pacts/");
        Integer eta = new WhenComesTheBus(provider.getPort()).checkEta("London", "700");
        System.out.println("According to test eta="+eta);
        assertFalse(eta >= 0);
    }*/
    ...
    @Test
    @PactVerification()
    public void doStatusCodeTest() {
        System.setProperty("pact.rootDir","target/pacts/");
        int actual_port = new WhenComesTheBus(provider.getPort()).checkEta("Hammersmith", "613");
        System.out.println("Actual port - " + actual_port);
        //assertEquals("Assertion Error: Invalid PORT", 8111, actual_port);
    }
}
